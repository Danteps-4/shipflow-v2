...
const TOOL_GROUPS = [
  ...
  },
  {
    ...
    tools: [
      ...
      {
        href: "/finanzas/conciliacion-transferencias",
        icon: "fas fa-money-bill-transfer",
        color: "#3b82f6",
        title: "Conciliación de transferencias",
        description: "Detecta avisos de transferencias por Telegram y los matchea contra pedidos pendientes de pago en Tiendanube.",
        tags: ["Transferencias", "Telegram", "Tiendanube"],
      },
    ],
  },
  {
