...
// Búsqueda/listado de pedidos para el flujo "Crear retiro presencial".
// Guard propio del módulo "retiros" (no reusa el de "tickets"/"pedidos": el
// personal de depósito/atención puede no tener esos módulos). Réplica corta
// de app/api/tickets/orders/route.ts — mismo patrón, no se llama a esa ruta
// para no acoplar los dos módulos.
